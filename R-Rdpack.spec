...
Version  : 0.9.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/Rdpack_0.9-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Rdpack_0.9-0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535141030
